...
#define _loop0_98_type 1257
#define _gather_97_type 1258
...
#define _loop1_156_type 1316
#define _loop1_157_type 1317
#define _tmp_158_type 1318
#define _tmp_159_type 1319
...
// slices: slice !',' | ','.slice+ ["," kwargs] | ','.slice+ ','?
static expr_ty
slices_rule(Parser *p)
{
    ...
    { // ','.slice+ ["," kwargs]
        ...
        D(fprintf(stderr, "%*c> slices[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "','.slice+ [\",\" kwargs]"));
        asdl_expr_seq* a;
        void *b;
        if (
            (a = (asdl_expr_seq*)_gather_94_rule(p))  // ','.slice+
            &&
            (b = _tmp_96_rule(p), 1)  // ["," kwargs]
        )
        {
            D(fprintf(stderr, "%*c+ slices[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.slice+ [\",\" kwargs]"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _PyPegen_extended_getitem ( p , a , b , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s slices[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "','.slice+ [\",\" kwargs]"));
    }
    { // ','.slice+ ','?
        if (p->error_indicator) {
            D(p->level--);
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_97_rule(p))  // ','.slice+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
atom_rule(Parser *p)
{
    ...
    { // &'(' (tuple | group | genexp)
        ...
        if (
            ...
            &&
            (_tmp_100_var = _tmp_100_rule(p))  // tuple | group | genexp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'(' (tuple | group | genexp)"));
            _res = _tmp_100_var;
    ...
    { // &'[' (list | listcomp)
        ...
        if (
            ...
            &&
            (_tmp_101_var = _tmp_101_rule(p))  // list | listcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'[' (list | listcomp)"));
            _res = _tmp_101_var;
    ...
    { // &'{' (dict | set | dictcomp | setcomp)
        ...
        if (
            ...
            &&
            (_tmp_102_var = _tmp_102_rule(p))  // dict | set | dictcomp | setcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'{' (dict | set | dictcomp | setcomp)"));
            _res = _tmp_102_var;
...
tuple_rule(Parser *p)
{
    ...
    { // '(' [star_named_expression ',' star_named_expressions?] ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_104_rule(p), 1)  // [star_named_expression ',' star_named_expressions?]
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
group_rule(Parser *p)
{
    ...
    { // '(' (yield_expr | named_expression) ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_105_rule(p))  // yield_expr | named_expression
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
double_starred_kvpairs_rule(Parser *p)
{
    ...
    { // ','.double_starred_kvpair+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_106_rule(p))  // ','.double_starred_kvpair+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
for_if_clauses_rule(Parser *p)
{
    ...
    { // for_if_clause+
        ...
        if (
            (a = (asdl_comprehension_seq*)_loop1_108_rule(p))  // for_if_clause+
        )
        {
...
for_if_clause_rule(Parser *p)
{
    ...
    { // ASYNC 'for' star_targets 'in' ~ disjunction (('if' disjunction))*
        ...
        if (
            ...
            (b = disjunction_rule(p))  // disjunction
            &&
            (c = (asdl_expr_seq*)_loop0_109_rule(p))  // (('if' disjunction))*
        )
        {
    ...
    { // 'for' star_targets 'in' ~ disjunction (('if' disjunction))*
        ...
        if (
            ...
            (b = disjunction_rule(p))  // disjunction
            &&
            (c = (asdl_expr_seq*)_loop0_110_rule(p))  // (('if' disjunction))*
        )
        {
            D(fprintf(stderr, "%*c+ for_if_clause[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'for' star_targets 'in' ~ disjunction (('if' disjunction))*"));
...
args_rule(Parser *p)
{
    ...
    { // ','.(starred_expression | named_expression !'=')+ [',' kwargs]
        ...
        void *b;
        if (
            (a = (asdl_expr_seq*)_gather_111_rule(p))  // ','.(starred_expression | named_expression !'=')+
            &&
            (b = _tmp_113_rule(p), 1)  // [',' kwargs]
        )
        {
...
kwargs_rule(Parser *p)
{
    ...
    { // ','.kwarg_or_starred+ ',' ','.kwarg_or_double_starred+
        ...
        asdl_seq * b;
        if (
            (a = _gather_114_rule(p))  // ','.kwarg_or_starred+
            &&
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _gather_116_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
    ...
    { // ','.kwarg_or_starred+
        ...
        if (
            (_gather_118_var = _gather_118_rule(p))  // ','.kwarg_or_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_starred+"));
    ...
    { // ','.kwarg_or_double_starred+
        ...
        asdl_seq * _gather_120_var;
        if (
            (_gather_120_var = _gather_120_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_double_starred+"));
            _res = _gather_120_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s kwargs[%d-%d]: %s failed!\n", p->level, ' ',
...
star_targets_rule(Parser *p)
{
    ...
    { // star_target ((',' star_target))* ','?
        ...
        if (
            (a = star_target_rule(p))  // star_target
            &&
            (b = _loop0_122_rule(p))  // ((',' star_target))*
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_targets_seq_rule(Parser *p)
{
    ...
    { // ','.star_target+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_123_rule(p))  // ','.star_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
targets_rule(Parser *p)
{
    ...
    { // ','.target+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_128_rule(p))  // ','.target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
incorrect_arguments_rule(Parser *p)
{
    ...
    { // expression for_if_clauses ',' [args | expression for_if_clauses]
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_130_rule(p), 1)  // [args | expression for_if_clauses]
        )
        {
            D(fprintf(stderr, "%*c+ incorrect_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression for_if_clauses ',' [args | expression for_if_clauses]"));
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions* ':' expression
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_loop0_131_var = _loop0_131_rule(p))  // star_named_expressions*
            &&
    ...
    { // ((star_targets '='))* star_expressions '='
        ...
        expr_ty a;
        if (
            (_loop0_132_var = _loop0_132_rule(p))  // ((star_targets '='))*
            &&
    ...
    { // ((star_targets '='))* yield_expr '='
        ...
        expr_ty a;
        if (
            (_loop0_133_var = _loop0_133_rule(p))  // ((star_targets '='))*
            &&
    ...
    { // star_expressions augassign (yield_expr | star_expressions)
        ...
        if (
            ...
            &&
            (_tmp_134_var = _tmp_134_rule(p))  // yield_expr | star_expressions
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_expressions augassign (yield_expr | star_expressions)"));
...
invalid_parameters_rule(Parser *p)
{
    ...
    { // param_no_default* (slash_with_default | param_with_default+) param_no_default
        ...
        if (
            (_loop0_136_var = _loop0_136_rule(p))  // param_no_default*
            &&
            (_tmp_137_var = _tmp_137_rule(p))  // slash_with_default | param_with_default+
            &&
...
invalid_lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* (lambda_slash_with_default | lambda_param_with_default+) lambda_param_no_default
        ...
        if (
            (_loop0_138_var = _loop0_138_rule(p))  // lambda_param_no_default*
            &&
            (_tmp_139_var = _tmp_139_rule(p))  // lambda_slash_with_default | lambda_param_with_default+
            &&
...
_loop1_22_rule(Parser *p)
{
    ...
    { // (star_targets '=')
        ...
        void *_tmp_142_var;
        while (
            (_tmp_142_var = _tmp_142_rule(p))  // star_targets '='
        )
        {
            _res = _tmp_142_var;
            if (_n == _children_capacity) {
...
_loop1_68_rule(Parser *p)
{
    ...
    { // ('@' named_expression NEWLINE)
        ...
        void *_tmp_145_var;
        while (
            (_tmp_145_var = _tmp_145_rule(p))  // '@' named_expression NEWLINE
        )
        {
            _res = _tmp_145_var;
            if (_n == _children_capacity) {
...
_loop1_72_rule(Parser *p)
{
    ...
    { // (',' star_expression)
        ...
        void *_tmp_146_var;
        while (
            (_tmp_146_var = _tmp_146_rule(p))  // ',' star_expression
        )
        {
            _res = _tmp_146_var;
            if (_n == _children_capacity) {
...
_loop1_75_rule(Parser *p)
{
    ...
    { // (',' expression)
        ...
        void *_tmp_147_var;
        while (
            (_tmp_147_var = _tmp_147_rule(p))  // ',' expression
        )
        {
            _res = _tmp_147_var;
            if (_n == _children_capacity) {
...
_loop1_90_rule(Parser *p)
{
    ...
    { // ('or' conjunction)
        ...
        void *_tmp_148_var;
        while (
            (_tmp_148_var = _tmp_148_rule(p))  // 'or' conjunction
        )
        {
            _res = _tmp_148_var;
            if (_n == _children_capacity) {
...
_loop1_91_rule(Parser *p)
{
    ...
    { // ('and' inversion)
        ...
        void *_tmp_149_var;
        while (
            (_tmp_149_var = _tmp_149_rule(p))  // 'and' inversion
        )
        {
            _res = _tmp_149_var;
            if (_n == _children_capacity) {
...
_gather_97_rule(Parser *p)
{
    ...
    { // slice _loop0_98
        ...
        D(fprintf(stderr, "%*c> _gather_97[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "slice _loop0_98"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = slice_rule(p))  // slice
        ...
        D(fprintf(stderr, "%*c%s _gather_97[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "slice _loop0_98"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_107: ',' double_starred_kvpair
static asdl_seq *
...
// _gather_106: double_starred_kvpair _loop0_107
static asdl_seq *
_gather_106_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // double_starred_kvpair _loop0_107
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_106[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "double_starred_kvpair _loop0_107"));
        KeyValuePair* elem;
        asdl_seq * seq;
        if (
            (elem = double_starred_kvpair_rule(p))  // double_starred_kvpair
        ...
        D(fprintf(stderr, "%*c%s _gather_106[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "double_starred_kvpair _loop0_107"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop0_109_rule(Parser *p)
{
    ...
    { // ('if' disjunction)
        ...
        void *_tmp_150_var;
        while (
            (_tmp_150_var = _tmp_150_rule(p))  // 'if' disjunction
        )
        {
            _res = _tmp_150_var;
            if (_n == _children_capacity) {
...
_loop0_110_rule(Parser *p)
{
    ...
    { // ('if' disjunction)
        ...
        void *_tmp_151_var;
        while (
            (_tmp_151_var = _tmp_151_rule(p))  // 'if' disjunction
        )
        {
            _res = _tmp_151_var;
            if (_n == _children_capacity) {
...
// _loop0_112: ',' (starred_expression | named_expression !'=')
static asdl_seq *
_loop0_112_rule(Parser *p)
{
    ...
    { // ',' (starred_expression | named_expression !'=')
        ...
        while (
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (elem = _tmp_152_rule(p))  // starred_expression | named_expression !'='
        )
        {
            _res = elem;
            if (_res == NULL && PyErr_Occurred()) {
...
// _gather_111: (starred_expression | named_expression !'=') _loop0_112
static asdl_seq *
_gather_111_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // (starred_expression | named_expression !'=') _loop0_112
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_111[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "(starred_expression | named_expression !'=') _loop0_112"));
        void *elem;
        asdl_seq * seq;
        if (
            (elem = _tmp_152_rule(p))  // starred_expression | named_expression !'='
        ...
        D(fprintf(stderr, "%*c%s _gather_111[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "(starred_expression | named_expression !'=') _loop0_112"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_118_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_starred _loop0_119
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_118[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_starred _loop0_119"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_starred_rule(p))  // kwarg_or_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_118[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_starred _loop0_119"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_120_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_double_starred _loop0_121
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_120[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_double_starred _loop0_121"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_double_starred_rule(p))  // kwarg_or_double_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_120[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_double_starred _loop0_121"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop0_122_rule(Parser *p)
{
    ...
    { // (',' star_target)
        ...
        void *_tmp_153_var;
        while (
            (_tmp_153_var = _tmp_153_rule(p))  // ',' star_target
        )
        {
            _res = _tmp_153_var;
            if (_n == _children_capacity) {
...
// _gather_123: star_target _loop0_124
static asdl_seq *
_gather_123_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_target _loop0_124
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_123[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_target _loop0_124"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_target_rule(p))  // star_target
        ...
        D(fprintf(stderr, "%*c%s _gather_123[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_target _loop0_124"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_128_rule(Parser *p)
{
    ...
    { // target _loop0_129
        ...
        D(fprintf(stderr, "%*c> _gather_128[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "target _loop0_129"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = target_rule(p))  // target
        ...
        D(fprintf(stderr, "%*c%s _gather_128[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "target _loop0_129"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_130: args | expression for_if_clauses
static void *
...
// _loop0_131: star_named_expressions
static asdl_seq *
...
// _tmp_134: yield_expr | star_expressions
static void *
...
// _tmp_137: slash_with_default | param_with_default+
static void *
...
// _tmp_139: lambda_slash_with_default | lambda_param_with_default+
static void *
...
_tmp_140_rule(Parser *p)
{
    ...
    { // ',' (')' | '**')
        ...
        {
            D(fprintf(stderr, "%*c+ _tmp_140[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "',' (')' | '**')"));
            _res = _PyPegen_dummy_name(p, _literal, _tmp_158_var);
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_140[%d-%d]: %s failed!\n", p->level, ' ',
...
// _tmp_145: '@' named_expression NEWLINE
static void *
...
// _tmp_152: starred_expression | named_expression !'='
static void *
