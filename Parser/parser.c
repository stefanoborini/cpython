...
#define invalid_subscript_type 1158  // Left-recursive
...
#define _tmp_94_type 1255
#define _loop0_96_type 1256
#define _gather_95_type 1257
#define _tmp_97_type 1258
#define _tmp_98_type 1259
#define _tmp_99_type 1260
#define _tmp_100_type 1261
#define _loop1_101_type 1262
#define _tmp_102_type 1263
#define _tmp_103_type 1264
#define _loop0_105_type 1265
#define _gather_104_type 1266
#define _loop1_106_type 1267
#define _loop0_107_type 1268
#define _loop0_108_type 1269
#define _loop0_110_type 1270
#define _gather_109_type 1271
#define _tmp_111_type 1272
#define _loop0_113_type 1273
#define _gather_112_type 1274
#define _loop0_115_type 1275
#define _gather_114_type 1276
#define _loop0_117_type 1277
#define _gather_116_type 1278
#define _loop0_119_type 1279
#define _gather_118_type 1280
#define _loop0_120_type 1281
#define _loop0_122_type 1282
#define _gather_121_type 1283
#define _tmp_123_type 1284
#define _loop0_125_type 1285
#define _gather_124_type 1286
#define _loop0_127_type 1287
#define _gather_126_type 1288
#define _tmp_128_type 1289
#define _loop0_129_type 1290
#define _loop0_130_type 1291
#define _loop0_131_type 1292
#define _tmp_132_type 1293
#define _tmp_133_type 1294
#define _loop0_134_type 1295
#define _tmp_135_type 1296
#define _loop0_136_type 1297
...
#define _tmp_153_type 1314
#define _loop1_154_type 1315
#define _loop1_155_type 1316
#define _tmp_156_type 1317
#define _tmp_157_type 1318
...
static void *invalid_subscript_rule(Parser *p);
...
primary_raw(Parser *p)
{
    ...
    { // primary '[' slices [',' kwargs] ']'
        ...
        D(fprintf(stderr, "%*c> primary[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "primary '[' slices [',' kwargs] ']'"));
        Token * _literal;
        Token * _literal_1;
        expr_ty a;
        expr_ty b;
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_Subscript ( a , b , CHECK_NULL_ALLOWED ( _PyPegen_seq_delete_starred_exprs ( p , c ) ) , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s primary[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "primary '[' slices [',' kwargs] ']'"));
    }
    { // invalid_subscript
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> primary[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "invalid_subscript"));
        void *invalid_subscript_var;
        if (
            (invalid_subscript_var = invalid_subscript_rule(p))  // invalid_subscript
        )
        {
            D(fprintf(stderr, "%*c+ primary[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "invalid_subscript"));
            _res = invalid_subscript_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s primary[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "invalid_subscript"));
    }
    { // atom
        if (p->error_indicator) {
            D(p->level--);
...
slices_rule(Parser *p)
{
    ...
    { // ','.slice+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_95_rule(p))  // ','.slice+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
atom_rule(Parser *p)
{
    ...
    { // &'(' (tuple | group | genexp)
        ...
        if (
            ...
            &&
            (_tmp_98_var = _tmp_98_rule(p))  // tuple | group | genexp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'(' (tuple | group | genexp)"));
            _res = _tmp_98_var;
    ...
    { // &'[' (list | listcomp)
        ...
        if (
            ...
            &&
            (_tmp_99_var = _tmp_99_rule(p))  // list | listcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'[' (list | listcomp)"));
            _res = _tmp_99_var;
    ...
    { // &'{' (dict | set | dictcomp | setcomp)
        ...
        if (
            ...
            &&
            (_tmp_100_var = _tmp_100_rule(p))  // dict | set | dictcomp | setcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'{' (dict | set | dictcomp | setcomp)"));
            _res = _tmp_100_var;
...
tuple_rule(Parser *p)
{
    ...
    { // '(' [star_named_expression ',' star_named_expressions?] ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_102_rule(p), 1)  // [star_named_expression ',' star_named_expressions?]
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
group_rule(Parser *p)
{
    ...
    { // '(' (yield_expr | named_expression) ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_103_rule(p))  // yield_expr | named_expression
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
double_starred_kvpairs_rule(Parser *p)
{
    ...
    { // ','.double_starred_kvpair+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_104_rule(p))  // ','.double_starred_kvpair+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
for_if_clauses_rule(Parser *p)
{
    ...
    { // for_if_clause+
        ...
        if (
            (a = (asdl_comprehension_seq*)_loop1_106_rule(p))  // for_if_clause+
        )
        {
...
for_if_clause_rule(Parser *p)
{
    ...
    { // 'for' star_targets 'in' ~ disjunction (('if' disjunction))*
        ...
        if (
            ...
            (b = disjunction_rule(p))  // disjunction
            &&
            (c = (asdl_expr_seq*)_loop0_108_rule(p))  // (('if' disjunction))*
        )
        {
            D(fprintf(stderr, "%*c+ for_if_clause[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'for' star_targets 'in' ~ disjunction (('if' disjunction))*"));
...
args_rule(Parser *p)
{
    ...
    { // ','.(starred_expression | named_expression !'=')+ [',' kwargs]
        ...
        void *b;
        if (
            (a = (asdl_expr_seq*)_gather_109_rule(p))  // ','.(starred_expression | named_expression !'=')+
            &&
            (b = _tmp_111_rule(p), 1)  // [',' kwargs]
        )
        {
...
kwargs_rule(Parser *p)
{
    ...
    { // ','.kwarg_or_starred+ ',' ','.kwarg_or_double_starred+
        ...
        asdl_seq * b;
        if (
            (a = _gather_112_rule(p))  // ','.kwarg_or_starred+
            &&
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _gather_114_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
    ...
    { // ','.kwarg_or_starred+
        ...
        if (
            (_gather_116_var = _gather_116_rule(p))  // ','.kwarg_or_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_starred+"));
    ...
    { // ','.kwarg_or_double_starred+
        ...
        asdl_seq * _gather_118_var;
        if (
            (_gather_118_var = _gather_118_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_double_starred+"));
            _res = _gather_118_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s kwargs[%d-%d]: %s failed!\n", p->level, ' ',
...
star_targets_rule(Parser *p)
{
    ...
    { // star_target ((',' star_target))* ','?
        ...
        if (
            (a = star_target_rule(p))  // star_target
            &&
            (b = _loop0_120_rule(p))  // ((',' star_target))*
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_targets_seq_rule(Parser *p)
{
    ...
    { // ','.star_target+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_121_rule(p))  // ','.star_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
del_targets_rule(Parser *p)
{
    ...
    { // ','.del_target+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_124_rule(p))  // ','.del_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
targets_rule(Parser *p)
{
    ...
    { // ','.target+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_126_rule(p))  // ','.target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
incorrect_arguments_rule(Parser *p)
{
    ...
    { // expression for_if_clauses ',' [args | expression for_if_clauses]
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_128_rule(p), 1)  // [args | expression for_if_clauses]
        )
        {
            D(fprintf(stderr, "%*c+ incorrect_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression for_if_clauses ',' [args | expression for_if_clauses]"));
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions* ':' expression
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_loop0_129_var = _loop0_129_rule(p))  // star_named_expressions*
            &&
    ...
    { // ((star_targets '='))* yield_expr '='
        ...
        expr_ty a;
        if (
            (_loop0_131_var = _loop0_131_rule(p))  // ((star_targets '='))*
            &&
    ...
    { // star_expressions augassign (yield_expr | star_expressions)
        ...
        if (
            ...
            &&
            (_tmp_132_var = _tmp_132_rule(p))  // yield_expr | star_expressions
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_expressions augassign (yield_expr | star_expressions)"));
...
invalid_parameters_rule(Parser *p)
{
    ...
    { // param_no_default* (slash_with_default | param_with_default+) param_no_default
        ...
        if (
            (_loop0_134_var = _loop0_134_rule(p))  // param_no_default*
            &&
            (_tmp_135_var = _tmp_135_rule(p))  // slash_with_default | param_with_default+
            &&
...
invalid_lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* (lambda_slash_with_default | lambda_param_with_default+) lambda_param_no_default
        ...
        asdl_seq * _loop0_136_var;
        void *_tmp_137_var;
        arg_ty lambda_param_no_default_var;
        if (
            (_loop0_136_var = _loop0_136_rule(p))  // lambda_param_no_default*
            &&
            (_tmp_137_var = _tmp_137_rule(p))  // lambda_slash_with_default | lambda_param_with_default+
            &&
...
// Left-recursive
// invalid_subscript: primary '[' ']'
static void *
invalid_subscript_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    { // primary '[' ']'
        ...
        D(fprintf(stderr, "%*c> invalid_subscript[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "primary '[' ']'"));
        Token * _literal;
        Token * _literal_1;
        expr_ty primary_var;
        if (
        ...
        {
            D(fprintf(stderr, "%*c+ invalid_subscript[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "primary '[' ']'"));
            _res = RAISE_SYNTAX_ERROR ( "Indexing argument cannot be empty" );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s invalid_subscript[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "primary '[' ']'"));
    }
    _res = NULL;
  done:
...
_loop1_22_rule(Parser *p)
{
    ...
    { // (star_targets '=')
        ...
        void *_tmp_140_var;
        while (
            (_tmp_140_var = _tmp_140_rule(p))  // star_targets '='
        )
        {
            _res = _tmp_140_var;
            if (_n == _children_capacity) {
...
_loop1_68_rule(Parser *p)
{
    ...
    { // ('@' named_expression NEWLINE)
        ...
        void *_tmp_143_var;
        while (
            (_tmp_143_var = _tmp_143_rule(p))  // '@' named_expression NEWLINE
        )
        {
            _res = _tmp_143_var;
            if (_n == _children_capacity) {
...
_loop1_72_rule(Parser *p)
{
    ...
    { // (',' star_expression)
        ...
        void *_tmp_144_var;
        while (
            (_tmp_144_var = _tmp_144_rule(p))  // ',' star_expression
        )
        {
            _res = _tmp_144_var;
            if (_n == _children_capacity) {
...
_loop1_75_rule(Parser *p)
{
    ...
    { // (',' expression)
        ...
        void *_tmp_145_var;
        while (
            (_tmp_145_var = _tmp_145_rule(p))  // ',' expression
        )
        {
            _res = _tmp_145_var;
            if (_n == _children_capacity) {
...
_loop1_90_rule(Parser *p)
{
    ...
    { // ('or' conjunction)
        ...
        void *_tmp_146_var;
        while (
            (_tmp_146_var = _tmp_146_rule(p))  // 'or' conjunction
        )
        {
            _res = _tmp_146_var;
            if (_n == _children_capacity) {
...
_loop1_91_rule(Parser *p)
{
    ...
    { // ('and' inversion)
        ...
        void *_tmp_147_var;
        while (
            (_tmp_147_var = _tmp_147_rule(p))  // 'and' inversion
        )
        {
            _res = _tmp_147_var;
            if (_n == _children_capacity) {
...
_gather_95_rule(Parser *p)
{
    ...
    { // slice _loop0_96
        ...
        D(fprintf(stderr, "%*c> _gather_95[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "slice _loop0_96"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = slice_rule(p))  // slice
        ...
        D(fprintf(stderr, "%*c%s _gather_95[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "slice _loop0_96"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_102: star_named_expression ',' star_named_expressions?
static void *
...
// _tmp_103: yield_expr | named_expression
static void *
...
// _loop0_105: ',' double_starred_kvpair
static asdl_seq *
...
// _gather_104: double_starred_kvpair _loop0_105
static asdl_seq *
_gather_104_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // double_starred_kvpair _loop0_105
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_104[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "double_starred_kvpair _loop0_105"));
        KeyValuePair* elem;
        asdl_seq * seq;
        if (
            (elem = double_starred_kvpair_rule(p))  // double_starred_kvpair
        ...
        D(fprintf(stderr, "%*c%s _gather_104[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "double_starred_kvpair _loop0_105"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop0_108_rule(Parser *p)
{
    ...
    { // ('if' disjunction)
        ...
        void *_tmp_149_var;
        while (
            (_tmp_149_var = _tmp_149_rule(p))  // 'if' disjunction
        )
        {
            _res = _tmp_149_var;
            if (_n == _children_capacity) {
...
// _loop0_110: ',' (starred_expression | named_expression !'=')
static asdl_seq *
_loop0_110_rule(Parser *p)
{
    ...
    { // ',' (starred_expression | named_expression !'=')
        ...
        while (
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (elem = _tmp_150_rule(p))  // starred_expression | named_expression !'='
        )
        {
            _res = elem;
            if (_res == NULL && PyErr_Occurred()) {
...
// _gather_109: (starred_expression | named_expression !'=') _loop0_110
static asdl_seq *
_gather_109_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // (starred_expression | named_expression !'=') _loop0_110
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_109[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "(starred_expression | named_expression !'=') _loop0_110"));
        void *elem;
        asdl_seq * seq;
        if (
            (elem = _tmp_150_rule(p))  // starred_expression | named_expression !'='
        ...
        D(fprintf(stderr, "%*c%s _gather_109[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "(starred_expression | named_expression !'=') _loop0_110"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_112_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_starred _loop0_113
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_112[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_starred _loop0_113"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_starred_rule(p))  // kwarg_or_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_112[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_starred _loop0_113"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_114_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_double_starred _loop0_115
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_114[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_double_starred _loop0_115"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_double_starred_rule(p))  // kwarg_or_double_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_114[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_double_starred _loop0_115"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_116_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_starred _loop0_117
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_116[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_starred _loop0_117"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_starred_rule(p))  // kwarg_or_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_116[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_starred _loop0_117"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_118_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_double_starred _loop0_119
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_118[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_double_starred _loop0_119"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_double_starred_rule(p))  // kwarg_or_double_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_118[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_double_starred _loop0_119"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _gather_121: star_target _loop0_122
static asdl_seq *
_gather_121_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_target _loop0_122
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_121[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_target _loop0_122"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_target_rule(p))  // star_target
        ...
        D(fprintf(stderr, "%*c%s _gather_121[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_target _loop0_122"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _gather_124: del_target _loop0_125
static asdl_seq *
_gather_124_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // del_target _loop0_125
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_124[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "del_target _loop0_125"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = del_target_rule(p))  // del_target
        ...
        D(fprintf(stderr, "%*c%s _gather_124[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "del_target _loop0_125"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_126_rule(Parser *p)
{
    ...
    { // target _loop0_127
        ...
        D(fprintf(stderr, "%*c> _gather_126[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "target _loop0_127"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = target_rule(p))  // target
        ...
        D(fprintf(stderr, "%*c%s _gather_126[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "target _loop0_127"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_128: args | expression for_if_clauses
static void *
...
// _loop0_129: star_named_expressions
static asdl_seq *
...
// _tmp_137: lambda_slash_with_default | lambda_param_with_default+
static void *
...
_tmp_139_rule(Parser *p)
{
    ...
    { // ',' (':' | '**')
        ...
        {
            D(fprintf(stderr, "%*c+ _tmp_139[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "',' (':' | '**')"));
            _res = _PyPegen_dummy_name(p, _literal, _tmp_157_var);
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_139[%d-%d]: %s failed!\n", p->level, ' ',
...
// _tmp_143: '@' named_expression NEWLINE
static void *
...
// _tmp_150: starred_expression | named_expression !'='
static void *
