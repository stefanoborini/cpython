...
#define _tmp_154_type 1315
#define _tmp_155_type 1316
#define _tmp_156_type 1317
#define _loop1_157_type 1318
#define _loop1_158_type 1319
#define _tmp_159_type 1320
#define _tmp_160_type 1321
...
primary_raw(Parser *p)
{
    ...
    { // primary '[' kwargs ']'
        ...
        D(fprintf(stderr, "%*c> primary[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "primary '[' kwargs ']'"));
        Token * _literal;
        Token * _literal_1;
        expr_ty a;
        asdl_seq* c;
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_Subscript ( a , _Py_Tuple ( NULL , Load , EXTRA ) , CHECK_NULL_ALLOWED ( _PyPegen_seq_delete_starred_exprs ( p , c ) ) , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s primary[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "primary '[' kwargs ']'"));
    }
    { // primary '[' slices ']'
        if (p->error_indicator) {
            D(p->level--);
...
// del_target:
//     | t_primary '.' NAME !t_lookahead
//     | t_primary '[' kwargs ']' !t_lookahead
//     | t_primary '[' ','.slice+ ',' kwargs ']' !t_lookahead
//     | t_primary '[' slice ',' kwargs ']' !t_lookahead
//     | t_primary '[' slices ']' !t_lookahead
//     | del_t_atom
static expr_ty
del_target_rule(Parser *p)
{
    ...
    { // t_primary '[' kwargs ']' !t_lookahead
        ...
        D(fprintf(stderr, "%*c> del_target[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "t_primary '[' kwargs ']' !t_lookahead"));
        Token * _literal;
        Token * _literal_1;
        expr_ty a;
        asdl_seq* c;
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_Subscript ( a , NULL , CHECK_NULL_ALLOWED ( _PyPegen_seq_delete_starred_exprs ( p , c ) ) , Del , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s del_target[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "t_primary '[' kwargs ']' !t_lookahead"));
    }
    { // t_primary '[' ','.slice+ ',' kwargs ']' !t_lookahead
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> del_target[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "t_primary '[' ','.slice+ ',' kwargs ']' !t_lookahead"));
        Token * _literal;
        Token * _literal_1;
        Token * _literal_2;
        expr_ty a;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s del_target[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "t_primary '[' ','.slice+ ',' kwargs ']' !t_lookahead"));
    }
    { // t_primary '[' slice ',' kwargs ']' !t_lookahead
        if (p->error_indicator) {
            D(p->level--);
...
targets_rule(Parser *p)
{
    ...
    { // ','.target+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_127_rule(p))  // ','.target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
t_primary_raw(Parser *p)
{
    ...
    { // t_primary '[' ','.slice+ ',' kwargs ']' &t_lookahead
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_Subscript ( a , NULL , CHECK_NULL_ALLOWED ( _PyPegen_seq_delete_starred_exprs ( p , c ) ) , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
incorrect_arguments_rule(Parser *p)
{
    ...
    { // expression for_if_clauses ',' [args | expression for_if_clauses]
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_131_rule(p), 1)  // [args | expression for_if_clauses]
        )
        {
            D(fprintf(stderr, "%*c+ incorrect_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression for_if_clauses ',' [args | expression for_if_clauses]"));
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions* ':' expression
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_loop0_132_var = _loop0_132_rule(p))  // star_named_expressions*
            &&
    ...
    { // ((star_targets '='))* yield_expr '='
        ...
        expr_ty a;
        if (
            (_loop0_134_var = _loop0_134_rule(p))  // ((star_targets '='))*
            &&
    ...
    { // star_expressions augassign (yield_expr | star_expressions)
        ...
        if (
            ...
            &&
            (_tmp_135_var = _tmp_135_rule(p))  // yield_expr | star_expressions
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_expressions augassign (yield_expr | star_expressions)"));
...
invalid_parameters_rule(Parser *p)
{
    ...
    { // param_no_default* (slash_with_default | param_with_default+) param_no_default
        ...
        asdl_seq * _loop0_137_var;
        void *_tmp_138_var;
        arg_ty param_no_default_var;
        if (
            (_loop0_137_var = _loop0_137_rule(p))  // param_no_default*
            &&
            (_tmp_138_var = _tmp_138_rule(p))  // slash_with_default | param_with_default+
            &&
...
invalid_lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* (lambda_slash_with_default | lambda_param_with_default+) lambda_param_no_default
        ...
        if (
            (_loop0_139_var = _loop0_139_rule(p))  // lambda_param_no_default*
            &&
            (_tmp_140_var = _tmp_140_rule(p))  // lambda_slash_with_default | lambda_param_with_default+
            &&
...
_loop1_22_rule(Parser *p)
{
    ...
    { // (star_targets '=')
        ...
        void *_tmp_143_var;
        while (
            (_tmp_143_var = _tmp_143_rule(p))  // star_targets '='
        )
        {
            _res = _tmp_143_var;
            if (_n == _children_capacity) {
...
_loop1_68_rule(Parser *p)
{
    ...
    { // ('@' named_expression NEWLINE)
        ...
        void *_tmp_146_var;
        while (
            (_tmp_146_var = _tmp_146_rule(p))  // '@' named_expression NEWLINE
        )
        {
            _res = _tmp_146_var;
            if (_n == _children_capacity) {
...
_loop1_72_rule(Parser *p)
{
    ...
    { // (',' star_expression)
        ...
        void *_tmp_147_var;
        while (
            (_tmp_147_var = _tmp_147_rule(p))  // ',' star_expression
        )
        {
            _res = _tmp_147_var;
            if (_n == _children_capacity) {
...
_loop1_75_rule(Parser *p)
{
    ...
    { // (',' expression)
        ...
        void *_tmp_148_var;
        while (
            (_tmp_148_var = _tmp_148_rule(p))  // ',' expression
        )
        {
            _res = _tmp_148_var;
            if (_n == _children_capacity) {
...
_loop1_90_rule(Parser *p)
{
    ...
    { // ('or' conjunction)
        ...
        void *_tmp_149_var;
        while (
            (_tmp_149_var = _tmp_149_rule(p))  // 'or' conjunction
        )
        {
            _res = _tmp_149_var;
            if (_n == _children_capacity) {
...
_loop1_91_rule(Parser *p)
{
    ...
    { // ('and' inversion)
        ...
        void *_tmp_150_var;
        while (
            (_tmp_150_var = _tmp_150_rule(p))  // 'and' inversion
        )
        {
            _res = _tmp_150_var;
            if (_n == _children_capacity) {
...
_loop0_109_rule(Parser *p)
{
    ...
    { // ',' (starred_expression | named_expression !'=')
        ...
        while (
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (elem = _tmp_153_rule(p))  // starred_expression | named_expression !'='
        )
        {
            _res = elem;
            if (_res == NULL && PyErr_Occurred()) {
...
_loop0_119_rule(Parser *p)
{
    ...
    { // (',' star_target)
        ...
        void *_tmp_154_var;
        while (
            (_tmp_154_var = _tmp_154_rule(p))  // ',' star_target
        )
        {
            _res = _tmp_154_var;
            if (_n == _children_capacity) {
...
_gather_125_rule(Parser *p)
{
    ...
    { // slice _loop0_126
        ...
        D(fprintf(stderr, "%*c> _gather_125[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "slice _loop0_126"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = slice_rule(p))  // slice
        ...
        D(fprintf(stderr, "%*c%s _gather_125[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "slice _loop0_126"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_127_rule(Parser *p)
{
    ...
    { // target _loop0_128
        ...
        D(fprintf(stderr, "%*c> _gather_127[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "target _loop0_128"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = target_rule(p))  // target
        ...
        D(fprintf(stderr, "%*c%s _gather_127[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "target _loop0_128"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_129_rule(Parser *p)
{
    ...
    { // slice _loop0_130
        ...
        D(fprintf(stderr, "%*c> _gather_129[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "slice _loop0_130"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = slice_rule(p))  // slice
        ...
        D(fprintf(stderr, "%*c%s _gather_129[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "slice _loop0_130"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_131: args | expression for_if_clauses
static void *
...
// _loop0_132: star_named_expressions
static asdl_seq *
...
// _tmp_135: yield_expr | star_expressions
static void *
...
// _tmp_138: slash_with_default | param_with_default+
static void *
...
// _tmp_140: lambda_slash_with_default | lambda_param_with_default+
static void *
...
// _tmp_146: '@' named_expression NEWLINE
static void *
...
// _tmp_153: starred_expression | named_expression !'='
static void *
