...
#define star_targets_seq_type 1135
#define star_target_type 1136
#define star_atom_type 1137
#define single_target_type 1138
#define single_subscript_attribute_target_type 1139
#define del_targets_type 1140
#define del_target_type 1141
#define del_t_atom_type 1142
#define targets_type 1143
#define target_type 1144
#define t_primary_type 1145  // Left-recursive
#define t_lookahead_type 1146
#define t_atom_type 1147
#define invalid_arguments_type 1148
#define invalid_kwarg_type 1149
#define invalid_named_expression_type 1150
#define invalid_assignment_type 1151
#define invalid_ann_assign_target_type 1152
#define invalid_del_stmt_type 1153
#define invalid_block_type 1154
#define invalid_primary_type 1155  // Left-recursive
#define invalid_comprehension_type 1156
#define invalid_dict_comprehension_type 1157
#define invalid_parameters_type 1158
#define invalid_lambda_parameters_type 1159
#define invalid_star_etc_type 1160
#define invalid_lambda_star_etc_type 1161
#define invalid_double_type_comments_type 1162
#define invalid_with_item_type 1163
#define invalid_for_target_type 1164
#define invalid_group_type 1165
#define invalid_import_from_targets_type 1166
...
#define _tmp_92_type 1258
#define _tmp_93_type 1259
#define _tmp_94_type 1260
#define _tmp_95_type 1261
#define _loop1_96_type 1262
#define _tmp_97_type 1263
#define _tmp_98_type 1264
#define _loop0_100_type 1265
#define _gather_99_type 1266
#define _loop1_101_type 1267
#define _loop0_102_type 1268
#define _loop0_103_type 1269
#define _loop0_105_type 1270
#define _gather_104_type 1271
#define _tmp_106_type 1272
#define _loop0_108_type 1273
#define _gather_107_type 1274
...
#define _tmp_115_type 1281
#define _loop0_117_type 1282
#define _gather_116_type 1283
#define _tmp_118_type 1284
#define _loop0_120_type 1285
#define _gather_119_type 1286
#define _loop0_122_type 1287
#define _gather_121_type 1288
#define _loop0_124_type 1289
#define _gather_123_type 1290
#define _loop0_126_type 1291
#define _gather_125_type 1292
#define _tmp_127_type 1293
#define _tmp_128_type 1294
#define _loop0_129_type 1295
#define _loop0_131_type 1296
#define _gather_130_type 1297
#define _tmp_132_type 1298
#define _loop0_134_type 1299
#define _gather_133_type 1300
#define _loop0_136_type 1301
#define _gather_135_type 1302
#define _tmp_137_type 1303
#define _loop0_138_type 1304
#define _loop0_139_type 1305
#define _loop0_140_type 1306
#define _tmp_141_type 1307
#define _tmp_142_type 1308
#define _loop0_143_type 1309
#define _tmp_144_type 1310
#define _loop0_145_type 1311
...
#define _loop1_164_type 1330
#define _loop1_165_type 1331
#define _tmp_166_type 1332
#define _tmp_167_type 1333
...
targets_rule(Parser *p)
{
    ...
    { // ','.target+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_135_rule(p))  // ','.target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
invalid_arguments_rule(Parser *p)
{
    ...
    { // expression for_if_clauses ',' [args | expression for_if_clauses]
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_137_rule(p), 1)  // [args | expression for_if_clauses]
        )
        {
            D(fprintf(stderr, "%*c+ invalid_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression for_if_clauses ',' [args | expression for_if_clauses]"));
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions* ':' expression
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_loop0_138_var = _loop0_138_rule(p))  // star_named_expressions*
            &&
    ...
    { // ((star_targets '='))* star_expressions '='
        ...
        expr_ty a;
        if (
            (_loop0_139_var = _loop0_139_rule(p))  // ((star_targets '='))*
            &&
    ...
    { // star_expressions augassign (yield_expr | star_expressions)
        ...
        if (
            ...
            &&
            (_tmp_141_var = _tmp_141_rule(p))  // yield_expr | star_expressions
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_expressions augassign (yield_expr | star_expressions)"));
...
invalid_parameters_rule(Parser *p)
{
    ...
    { // param_no_default* (slash_with_default | param_with_default+) param_no_default
        ...
        if (
            (_loop0_143_var = _loop0_143_rule(p))  // param_no_default*
            &&
            (_tmp_144_var = _tmp_144_rule(p))  // slash_with_default | param_with_default+
            &&
...
invalid_lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* (lambda_slash_with_default | lambda_param_with_default+) lambda_param_no_default
        ...
        if (
            (_loop0_145_var = _loop0_145_rule(p))  // lambda_param_no_default*
            &&
            (_tmp_146_var = _tmp_146_rule(p))  // lambda_slash_with_default | lambda_param_with_default+
            &&
...
_loop1_73_rule(Parser *p)
{
    ...
    { // (',' expression)
        ...
        void *_tmp_154_var;
        while (
            (_tmp_154_var = _tmp_154_rule(p))  // ',' expression
        )
        {
            _res = _tmp_154_var;
            if (_n == _children_capacity) {
...
_loop1_88_rule(Parser *p)
{
    ...
    { // ('or' conjunction)
        ...
        void *_tmp_155_var;
        while (
            (_tmp_155_var = _tmp_155_rule(p))  // 'or' conjunction
        )
        {
            _res = _tmp_155_var;
            if (_n == _children_capacity) {
...
_loop1_89_rule(Parser *p)
{
    ...
    { // ('and' inversion)
        ...
        void *_tmp_156_var;
        while (
            (_tmp_156_var = _tmp_156_rule(p))  // 'and' inversion
        )
        {
            _res = _tmp_156_var;
            if (_n == _children_capacity) {
...
_loop0_102_rule(Parser *p)
{
    ...
    { // ('if' disjunction)
        ...
        void *_tmp_157_var;
        while (
            (_tmp_157_var = _tmp_157_rule(p))  // 'if' disjunction
        )
        {
            _res = _tmp_157_var;
            if (_n == _children_capacity) {
...
_loop0_105_rule(Parser *p)
{
    ...
    { // ',' (starred_expression | named_expression !'=')
        ...
        while (
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (elem = _tmp_159_rule(p))  // starred_expression | named_expression !'='
        )
        {
            _res = elem;
            if (_res == NULL && PyErr_Occurred()) {
...
_loop0_117_rule(Parser *p)
{
    ...
    { // ',' (slice | slice_starred_expression | named_expression !'=')
        ...
        while (
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (elem = _tmp_160_rule(p))  // slice | slice_starred_expression | named_expression !'='
        )
        {
            _res = elem;
            if (_res == NULL && PyErr_Occurred()) {
...
_loop0_129_rule(Parser *p)
{
    ...
    { // (',' star_target)
        ...
        void *_tmp_161_var;
        while (
            (_tmp_161_var = _tmp_161_rule(p))  // ',' star_target
        )
        {
            _res = _tmp_161_var;
            if (_n == _children_capacity) {
...
_gather_135_rule(Parser *p)
{
    ...
    { // target _loop0_136
        ...
        D(fprintf(stderr, "%*c> _gather_135[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "target _loop0_136"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = target_rule(p))  // target
        ...
        D(fprintf(stderr, "%*c%s _gather_135[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "target _loop0_136"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_137: args | expression for_if_clauses
static void *
...
// _loop0_138: star_named_expressions
static asdl_seq *
...
// _tmp_141: yield_expr | star_expressions
static void *
...
// _tmp_144: slash_with_default | param_with_default+
static void *
_tmp_144_rule(Parser *p)
{
    ...
    { // param_with_default+
        ...
        if (
            (_loop1_164_var = _loop1_164_rule(p))  // param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_144[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "param_with_default+"));
            _res = _loop1_164_var;
...
// _tmp_146: lambda_slash_with_default | lambda_param_with_default+
static void *
_tmp_146_rule(Parser *p)
{
    ...
    { // lambda_param_with_default+
        ...
        if (
            (_loop1_165_var = _loop1_165_rule(p))  // lambda_param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_146[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "lambda_param_with_default+"));
            _res = _loop1_165_var;
...
// _tmp_159: starred_expression | named_expression !'='
static void *
...
// _tmp_160: slice | slice_starred_expression | named_expression !'='
static void *
...
// _loop1_165: lambda_param_with_default
static asdl_seq *
