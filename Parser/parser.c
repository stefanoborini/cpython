...
#define _loop0_120_type 1280
#define _loop0_122_type 1281
#define _gather_121_type 1282
#define _tmp_123_type 1283
#define _tmp_124_type 1284
#define _tmp_125_type 1285
#define _loop0_127_type 1286
#define _gather_126_type 1287
#define _tmp_128_type 1288
#define _loop0_130_type 1289
#define _gather_129_type 1290
...
#define _loop0_136_type 1296
#define _tmp_137_type 1297
#define _tmp_138_type 1298
#define _loop0_139_type 1299
#define _tmp_140_type 1300
#define _loop0_141_type 1301
...
#define _tmp_157_type 1317
#define _tmp_158_type 1318
#define _loop1_159_type 1319
#define _loop1_160_type 1320
#define _tmp_161_type 1321
#define _tmp_162_type 1322
...
primary_raw(Parser *p)
{
    ...
    { // primary '[' slices [',' kwargs] ']'
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_Subscript ( a , b , c , Load , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
//     | t_primary '[' slices [',' kwargs] ']' !t_lookahead
//     | star_atom
static expr_ty
star_target_rule(Parser *p)
{
    ...
    { // t_primary '[' slices [',' kwargs] ']' !t_lookahead
        ...
        D(fprintf(stderr, "%*c> star_target[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "t_primary '[' slices [',' kwargs] ']' !t_lookahead"));
        Token * _literal;
        Token * _literal_1;
        expr_ty a;
        expr_ty b;
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_Subscript ( a , b , c , Store , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s star_target[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "t_primary '[' slices [',' kwargs] ']' !t_lookahead"));
    }
    { // star_atom
        if (p->error_indicator) {
            D(p->level--);
...
del_targets_rule(Parser *p)
{
    ...
    { // ','.del_target+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_126_rule(p))  // ','.del_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
del_target_rule(Parser *p)
{
    ...
    { // t_primary '[' slices [',' kwargs] ']' !t_lookahead
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_Subscript ( a , b , c , Del , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
targets_rule(Parser *p)
{
    ...
    { // ','.target+ ','?
        ...
        asdl_expr_seq* a;
        if (
            (a = (asdl_expr_seq*)_gather_129_rule(p))  // ','.target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
incorrect_arguments_rule(Parser *p)
{
    ...
    { // expression for_if_clauses ',' [args | expression for_if_clauses]
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_133_rule(p), 1)  // [args | expression for_if_clauses]
        )
        {
            D(fprintf(stderr, "%*c+ incorrect_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression for_if_clauses ',' [args | expression for_if_clauses]"));
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions* ':' expression
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_loop0_134_var = _loop0_134_rule(p))  // star_named_expressions*
            &&
    ...
    { // ((star_targets '='))* star_expressions '='
        ...
        expr_ty a;
        if (
            (_loop0_135_var = _loop0_135_rule(p))  // ((star_targets '='))*
            &&
    ...
    { // ((star_targets '='))* yield_expr '='
        ...
        expr_ty a;
        if (
            (_loop0_136_var = _loop0_136_rule(p))  // ((star_targets '='))*
            &&
    ...
    { // star_expressions augassign (yield_expr | star_expressions)
        ...
        if (
            ...
            &&
            (_tmp_137_var = _tmp_137_rule(p))  // yield_expr | star_expressions
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_expressions augassign (yield_expr | star_expressions)"));
...
invalid_parameters_rule(Parser *p)
{
    ...
    { // param_no_default* (slash_with_default | param_with_default+) param_no_default
        ...
        if (
            (_loop0_139_var = _loop0_139_rule(p))  // param_no_default*
            &&
            (_tmp_140_var = _tmp_140_rule(p))  // slash_with_default | param_with_default+
            &&
...
invalid_lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* (lambda_slash_with_default | lambda_param_with_default+) lambda_param_no_default
        ...
        if (
            (_loop0_141_var = _loop0_141_rule(p))  // lambda_param_no_default*
            &&
            (_tmp_142_var = _tmp_142_rule(p))  // lambda_slash_with_default | lambda_param_with_default+
            &&
...
_loop1_22_rule(Parser *p)
{
    ...
    { // (star_targets '=')
        ...
        void *_tmp_145_var;
        while (
            (_tmp_145_var = _tmp_145_rule(p))  // star_targets '='
        )
        {
            _res = _tmp_145_var;
            if (_n == _children_capacity) {
...
_loop1_68_rule(Parser *p)
{
    ...
    { // ('@' named_expression NEWLINE)
        ...
        void *_tmp_148_var;
        while (
            (_tmp_148_var = _tmp_148_rule(p))  // '@' named_expression NEWLINE
        )
        {
            _res = _tmp_148_var;
            if (_n == _children_capacity) {
...
_loop1_72_rule(Parser *p)
{
    ...
    { // (',' star_expression)
        ...
        void *_tmp_149_var;
        while (
            (_tmp_149_var = _tmp_149_rule(p))  // ',' star_expression
        )
        {
            _res = _tmp_149_var;
            if (_n == _children_capacity) {
...
_loop1_75_rule(Parser *p)
{
    ...
    { // (',' expression)
        ...
        void *_tmp_150_var;
        while (
            (_tmp_150_var = _tmp_150_rule(p))  // ',' expression
        )
        {
            _res = _tmp_150_var;
            if (_n == _children_capacity) {
...
_loop1_90_rule(Parser *p)
{
    ...
    { // ('or' conjunction)
        ...
        void *_tmp_151_var;
        while (
            (_tmp_151_var = _tmp_151_rule(p))  // 'or' conjunction
        )
        {
            _res = _tmp_151_var;
            if (_n == _children_capacity) {
...
_loop1_91_rule(Parser *p)
{
    ...
    { // ('and' inversion)
        ...
        void *_tmp_152_var;
        while (
            (_tmp_152_var = _tmp_152_rule(p))  // 'and' inversion
        )
        {
            _res = _tmp_152_var;
            if (_n == _children_capacity) {
...
_loop0_110_rule(Parser *p)
{
    ...
    { // ',' (starred_expression | named_expression !'=')
        ...
        while (
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (elem = _tmp_155_rule(p))  // starred_expression | named_expression !'='
        )
        {
            _res = elem;
            if (_res == NULL && PyErr_Occurred()) {
...
// _gather_126: del_target _loop0_127
static asdl_seq *
_gather_126_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // del_target _loop0_127
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_126[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "del_target _loop0_127"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = del_target_rule(p))  // del_target
        ...
        D(fprintf(stderr, "%*c%s _gather_126[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "del_target _loop0_127"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_129_rule(Parser *p)
{
    ...
    { // target _loop0_130
        ...
        D(fprintf(stderr, "%*c> _gather_129[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "target _loop0_130"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = target_rule(p))  // target
        ...
        D(fprintf(stderr, "%*c%s _gather_129[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "target _loop0_130"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_133: args | expression for_if_clauses
static void *
...
// _loop0_134: star_named_expressions
static asdl_seq *
...
// _tmp_137: yield_expr | star_expressions
static void *
...
// _tmp_140: slash_with_default | param_with_default+
static void *
...
// _tmp_142: lambda_slash_with_default | lambda_param_with_default+
static void *
_tmp_142_rule(Parser *p)
{
    ...
    { // lambda_param_with_default+
        ...
        if (
            (_loop1_160_var = _loop1_160_rule(p))  // lambda_param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_142[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "lambda_param_with_default+"));
            _res = _loop1_160_var;
...
// _tmp_148: '@' named_expression NEWLINE
static void *
...
// _tmp_155: starred_expression | named_expression !'='
static void *
...
// _loop1_160: lambda_param_with_default
static asdl_seq *
